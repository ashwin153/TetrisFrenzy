...
public enum Command {
	...
	CREATE_USER_FAILED,				// Server returns this when there is an error when creating a user
	CREATE_USER_SUCCESSFUL,			// Server returns this when it successfully creates a user
